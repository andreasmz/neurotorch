...
.. note:: 
    **Key features and short summary:**
    ...
    - It allows you to detect the location of synapses, which are called ROIs (region of interest)
...
* **B**: The delta video as input for detection, depending on what you selected as image source
